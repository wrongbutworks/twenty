...
import { AddLogoFileIdToApplicationRegistrationFastInstanceCommand } from './2-20/2-20-instance-command-fast-1783531289490-add-logo-file-id-to-application-registration';
